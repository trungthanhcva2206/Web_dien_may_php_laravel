window.addEventListener("scroll", function() {
  ...
  var mnsl = document.querySelector(".mnsl");
...
const showLink = document.getElementById("showmenu");
const outLink = document.getElementById("outl");
const hiddenDiv = document.getElementById("select_menu");
